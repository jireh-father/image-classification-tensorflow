...
tf.app.flags.DEFINE_string('dataset_dir', "c:/data/cifar10", "dataset_dir")
...
tf.app.flags.DEFINE_string('log_dir', os.path.join(os.path.dirname(os.path.realpath(__file__)), "checkpoint_cifar10_mean_epoch40"),
                           "save dir")
tf.app.flags.DEFINE_integer('vis_epoch', 4, "vis_epoch")
...
#  "checkpoint/model_epoch_9.ckpt", "model path to restore")
