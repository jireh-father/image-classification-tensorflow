...
tf.app.flags.DEFINE_string('dataset_name', "invariance_test", "dataset name")
# tf.app.flags.DEFINE_string('dataset_dir', "c:/data/face", "dataset_dir")

tf.app.flags.DEFINE_string('dataset_dir', "C:\data/invariance_test", "dataset_dir")
tf.app.flags.DEFINE_string('model_name', "alexnet_v2", "model name")
# tf.app.flags.DEFINE_string('model_name', "mean_fm", "model name")
tf.app.flags.DEFINE_integer('batch_size', 11, "batch_size")
tf.app.flags.DEFINE_integer('epoch', 40, "epoch")
...
tf.app.flags.DEFINE_boolean('eval', False, "eval")
tf.app.flags.DEFINE_float('train_fraction', 0, "train_fraction")
tf.app.flags.DEFINE_integer('num_channel', 3, "num channel")
tf.app.flags.DEFINE_integer('num_classes', None, "num_classes")
tf.app.flags.DEFINE_integer('num_dataset_parallel', 1, "num_dataset_parallel")
tf.app.flags.DEFINE_string('log_dir', os.path.join(os.path.dirname(os.path.realpath(__file__)), "checkpoint_face_alex_invariance_test3"),
                           "save dir")
tf.app.flags.DEFINE_integer('vis_epoch', 1, "vis_epoch")
tf.app.flags.DEFINE_integer('num_vis_steps', 10, "num_vis_steps")
tf.app.flags.DEFINE_integer('num_cam', 11, "num_cam")
tf.app.flags.DEFINE_integer('num_save_interval', 3, "num_save_interval")
...
tf.app.flags.DEFINE_string('restore_model_path', "checkpoint_face_alex/model_epoch_39.ckpt", "model path to restore")
