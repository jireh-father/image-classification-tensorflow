...
grid_params = {
    ...
    "dataset_name":
        {
            # "mustang": {"dataset_dir": "f:/data/mustang/grayscale_crop_under_sampling", "epoch": 5, 'vis_epoch': None,
            "mustang": {"dataset_dir": "/home/data/mustang/grayscale_crop_under_sampling", "epoch": 5,
                        'vis_epoch': None,
